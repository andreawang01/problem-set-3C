public class Elby {
    ...
    public String getResponse(String statement) {
        ...
        else if (findKeyword(statement, "Andrea", 0)>= 0)
        {
            response= "She seems like a smart person.";
        }
        else if (findKeyword(statement, "grade", 0)>= 0)
        {
            response= "How old are you?";
        }
        else if (findKeyword(statement, "today", 0)>= 0)
        {
            response= "Tell me about your day.";
        }
        else if (findKeyword(statement, "movie", 0)>= 0)
        {
            response= "What's your favourite movie of all time?";
        }
        else if (findKeyword(statement, "you", 0) >= 0
                && findKeyword(statement, "me", findKeyword(statement, "you", 0) + 3) >= 0)
        {
